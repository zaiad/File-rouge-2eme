...
function Users() {
  ...
  const getData = async () => {
    await axios
      .get(`http://localhost:8080/manager/get-users`)
      .then((res) => {
        setUsers(res.data);
      })
      .catch((err) => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`http://localhost:8080/livreur/add-livreur`, data)
      .then((res) => {
  ...
  return (
    <div className="flex w-screen">
      ...
      <div className="relative w-full h-screen px-3 overflow-x-auto shadow-md sm:rounded-lg">
        ...
        <div className="flex items-center justify-between py-4 bg-white dark:bg-gray-800 ">
          <h3 className="ml-2">Table for all users</h3>
          <button
            className="flex px-4 py-1 mr-4 font-bold text-white border-2 rounded-md bg-gray-500 hover:text-gray-500 hover:bg-white border-gray-500"
              ...
              <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center">
                    ...
                    ></div>{" "}
                    {(user.status && "Authorizde") || "Blocked"}
                  </div>
                </td>
                <td className="px-6 py-4">
                  <button
                    ...
                    className={
                      (user.status &&
                        "btn border bg-red-600 text-white rounded px-2 py-1 font-semibold hover: border-red-600 hover:bg-white hover:text-red-600") ||
                  ...
                  <div className="relative flex-auto p-6">
                    ...
                    >
                      ...
                      <div className="flex items-center justify-end p-6 border-t border-solid rounded-b border-slate-200">
                        ...
                        <button
                          className="px-6 py-3 mb-1 mr-1 text-sm font-bold text-white uppercase transition-all duration-150 ease-linear rounded shadow outline-none bg-gray-500 active:bg-gray-600 hover:shadow-lg focus:outline-none"
                          type="submit"
